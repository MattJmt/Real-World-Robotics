...
def main():
    ...
    file_path_dof = 'policy_recordings/rot_sphere_036_axis_010_90deg_sideways_2023-12-15_08-17-23_dof_poses.npy'
    ...
    with mujoco.viewer.launch_passive(m, d) as viewer:
        ...
        while not rospy.is_shutdown() and viewer.is_running() and time.time() - start < 300:
            ...
            for joint_idx in range(len(d.ctrl)):
                ...
                elif joint_idx == motornr_to_joint_dict["pointer0"]:
                    multiplier = 1
                    offset = np.deg2rad(35)

                elif joint_idx == motornr_to_joint_dict["pinky2"]:
                    multiplier = 1
                    offset = np.deg2rad(0)
                ...
                elif joint_idx == motornr_to_joint_dict["middle1"]:
