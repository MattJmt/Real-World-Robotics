...
JOINT_PARAMETER_NAMES = [
    'pointer_virtual_joint_1',
    'pointer_joint_1',
    'pointer_virtual_joint_2',
    'pointer_joint_2',
    'pointer_virtual_joint_3',
    'pointer_joint_3',
    'middle_virtual_joint_1',
    'middle_joint_1',
    'middle_virtual_joint_2',
    'middle_joint_2',
    'middle_virtual_joint_3',
    'middle_joint_3',
    'pinky_joint_0',
    'pinky_virtual_joint_1',
    'pinky_joint_1',
    'pinky_virtual_joint_2',
    'pinky_joint_2',
    'pinky_virtual_joint_3',
    'pinky_joint_3',
    'thumb_joint_0',
    'thumb_joint_1',
    'thumb_virtual_joint_2',
    'thumb_joint_2',
    'thumb_virtual_joint_3',
    'thumb_joint_3',
]
...
GC_TENDONS = {
    'pointer_virtual_joint_1': {'pointer_joint_1': 1},
    'pointer_virtual_joint_2': {'pointer_joint_2': 1, 'pointer_joint_3': 1, 'pointer_virtual_joint_3': 1},
    'middle_virtual_joint_1': {'middle_joint_1': 1},
    'middle_virtual_joint_2': {'middle_joint_2': 1, 'middle_joint_3': 1, 'middle_virtual_joint_3': 1},
    'pinky_virtual_joint_1': {'pinky_joint_1': 1},
    'pinky_virtual_joint_2': {'pinky_joint_2': 1, 'pinky_joint_3': 1, 'pinky_virtual_joint_3': 1},
    'thumb_virtual_joint_2': {'thumb_joint_2': 1},
    'thumb_virtual_joint_3': {'thumb_joint_3': 1},
}
...
FINGER_CHAINS = {
    'thumb': [
        ...
        'dynamixel_thumb',
        'thumb_2',
        'thumb_virtual_link_2',
        'thumb_3',
        'thumb_virtual_link_3',
        'thumb_4',
        'thumb_fingertip',
    ],
    'index': [
        ...
        'world2root_fixed',
        'palm',
        'pointer_virtual_link_1',
        'pointer_2',
        'pointer_virtual_link_2',
        'pointer_3',
        'pointer_virtual_link_3',
        'pointer_4',
        'pointer_fingertip',
    ],
    'middle': [
        ...
        'world2root_fixed',
        'palm',
        'middle_virtual_link_1',
        'middle_2',
        'middle_virtual_link_2',
        'middle_3',
        'middle_virtual_link_3',
        'middle_4',
        'middle_fingertip',
    ],
    'pinky': [
        ...
        'palm',
        'pinky_1'
        'pinky_virtual_link_1',
        'pinky_2',
        'pinky_virtual_link_2',
        'pinky_3',
        'pinky_virtual_link_3',
        'pinky_4',
        'pinky_fingertip',
    ],
}
...
def get_mano_joints_dict(joints: torch.Tensor, include_wrist=False, batch_processing=False):
    ...
    Args:
        ...
        include_wrist (bool, optional): _description_. Defaults to False.
        batch_processing (bool, optional): _description_. Defaults to False.

    Returns:
        _type_: _description_
    """    # For retargeting, we don't need the wrist
    # For visualization, we need the wrist
    # is this for the tracked real hand
